...
const SelectDropdown = (
  {
    ...
    dropDownListFooterComponent /* Add extra button bottom of FlatList for multiselect */,
    onDropDownClose /* function */,
    indicatorStyle /* color for flatlist scroll */
  },
  ref,
) => {
  ///////////////////////////////////////////////////////
      ...
      isVisible && (
        <Modal
          ...
          <View
            ...
            {dropDownListFooterComponent && dropDownListFooterComponent()}
          </View>
        </Modal>
      )
    );
